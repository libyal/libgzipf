...
#if !defined( _GZIPFTOOLS_GETOPT_H )
#define _GZIPFTOOLS_GETOPT_H
...
typedef struct gzipftools_option gzipftools_option_t;

struct gzipftools_option
{
...
#define gzipftools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t gzipftools_getopt(
                  int argument_count,
...
void gzipftools_getopt_wrapped_fprint(
      FILE *stream,
...
void gzipftools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const gzipftools_option_t *options,
      int number_of_options );

int gzipftools_getopt_get_options_string(
     const gzipftools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _GZIPFTOOLS_GETOPT_H ) */
