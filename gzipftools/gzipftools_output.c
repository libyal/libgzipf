/*
 * Common output functions for the gzipftools
 *
 ...
 */
void gzipftools_output_copyright_fprint(
      FILE *stream )
{
	if( stream == NULL )
	{
 ...
 */
void gzipftools_output_version_fprint(
      FILE *stream,
      const char *program )
{
	if( stream == NULL )
 ...
 */
void gzipftools_output_version_detailed_fprint(
      FILE *stream,
      const char *program )
{
	if( stream == NULL )
