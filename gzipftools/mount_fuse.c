...
int mount_fuse_readdir(
     ...
     void *buffer,
     fuse_fill_dir_t filler,
     off_t offset GZIPFTOOLS_ATTRIBUTE_UNUSED,
     struct fuse_file_info *file_info GZIPFTOOLS_ATTRIBUTE_UNUSED,
     enum fuse_readdir_flags flags GZIPFTOOLS_ATTRIBUTE_UNUSED )
#else
int mount_fuse_readdir(
     const char *path,
     void *buffer,
...
#endif
{
	...
	GZIPFTOOLS_UNREFERENCED_PARAMETER( offset )

#if defined( HAVE_LIBFUSE3 )
	GZIPFTOOLS_UNREFERENCED_PARAMETER( flags )
#endif
...
void mount_fuse_destroy(
      void *private_data GZIPFTOOLS_ATTRIBUTE_UNUSED )
{
	libcerror_error_t *error = NULL;
	static char *function    = "mount_fuse_destroy";

	GZIPFTOOLS_UNREFERENCED_PARAMETER( private_data )
