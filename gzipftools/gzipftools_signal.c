...
void (*gzipftools_signal_signal_handler)( gzipftools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( gzipftools_signal_signal_handler != NULL )
			{
				gzipftools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
 ...
 */
void gzipftools_signal_initialize_memory_debug(
      void )
{
	int flag = 0;
 ...
 */
int gzipftools_signal_attach(
     void (*signal_handler)( gzipftools_signal_t ),
     libcerror_error_t **error )
{
	static char *function = "gzipftools_signal_attach";
...
#if defined( _MSC_VER )
	gzipftools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	gzipftools_signal_signal_handler = NULL;
