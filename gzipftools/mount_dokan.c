...
extern mount_handle_t *gzipfmount_mount_handle;
...
int __stdcall mount_dokan_CreateFile(
               ...
               DWORD share_mode GZIPFTOOLS_ATTRIBUTE_UNUSED,
               DWORD creation_disposition,
               DWORD attribute_flags GZIPFTOOLS_ATTRIBUTE_UNUSED,
               DOKAN_FILE_INFO *file_info )
{
	...
	GZIPFTOOLS_UNREFERENCED_PARAMETER( share_mode )
	GZIPFTOOLS_UNREFERENCED_PARAMETER( attribute_flags )
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context GZIPFTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes GZIPFTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access GZIPFTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options GZIPFTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	GZIPFTOOLS_UNREFERENCED_PARAMETER( security_context )
	GZIPFTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	GZIPFTOOLS_UNREFERENCED_PARAMETER( share_access )
	GZIPFTOOLS_UNREFERENCED_PARAMETER( creation_options )
...
int __stdcall mount_dokan_GetFileInformation(
               const wchar_t *path,
               BY_HANDLE_FILE_INFORMATION *file_information,
               DOKAN_FILE_INFO *file_info GZIPFTOOLS_ATTRIBUTE_UNUSED )
#else
...
#endif
{
	...
	GZIPFTOOLS_UNREFERENCED_PARAMETER( file_info )
