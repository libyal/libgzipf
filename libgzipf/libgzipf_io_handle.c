...
{
	static char *function = "libgzipf_io_handle_initialize";
	...
	*io_handle = memory_allocate_structure(
	...
	if( memory_set(
	     *io_handle,
	     0,
	     sizeof( libgzipf_io_handle_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
...
int libgzipf_io_handle_free(
     ...
     libcerror_error_t **error )
{
	static char *function = "libgzipf_io_handle_free";
...
int libgzipf_io_handle_clear(
     ...
     libcerror_error_t **error )
{
	static char *function = "libgzipf_io_handle_clear";
