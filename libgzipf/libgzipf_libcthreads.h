...
#if !defined( _LIBGZIPF_LIBCTHREADS_H )
#define _LIBGZIPF_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBGZIPF )
#define HAVE_LIBGZIPF_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBGZIPF_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBGZIPF_LIBCTHREADS_H ) */
