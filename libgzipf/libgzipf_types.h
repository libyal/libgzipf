...
#if !defined( _LIBGZIPF_INTERNAL_TYPES_H )
#define _LIBGZIPF_INTERNAL_TYPES_H

#include <common.h>
#include <types.h>

/* Define HAVE_LOCAL_LIBGZIPF for local use of libgzipf
 * The definitions in <libgzipf/types.h> are copied here
...
#endif /* !defined( _LIBGZIPF_INTERNAL_TYPES_H ) */
