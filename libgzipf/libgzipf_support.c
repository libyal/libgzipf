...
const char *libgzipf_get_version(
             void )
{
	return( (const char *) LIBGZIPF_VERSION_STRING );
}
...
int libgzipf_get_access_flags_read(
     void )
{
	return( (int) LIBGZIPF_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libgzipf_get_codepage";
...
int libgzipf_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libgzipf_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libgzipf_check_file_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libgzipf_check_file_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libgzipf_check_file_signature_file_io_handle";
