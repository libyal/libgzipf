...
{
	static char *function = "libgzipf_notify_set_stream";
...
int libgzipf_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libgzipf_notify_stream_open";
...
int libgzipf_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libgzipf_notify_stream_close";
