...
#if !defined( _GZIPF_TEST_GETOPT_H )
#define _GZIPF_TEST_GETOPT_H
...
#define gzipf_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t gzipf_test_getopt(
                  int argument_count,
...
#endif /* !defined( _GZIPF_TEST_GETOPT_H ) */
