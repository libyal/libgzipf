...
$LibraryTests = "checksum compressed_block deflate error io_handle member member_descriptor member_footer member_header notify"
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\gzipf_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = "input\.libgzipf"
