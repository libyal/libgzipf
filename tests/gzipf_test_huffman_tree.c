...
uint8_t gzipf_test_huffman_tree_data[ 2627 ] = {
...
/* Tests the libgzipf_huffman_tree_initialize function
 * Returns 1 if successful or 0 if not
 */
int gzipf_test_huffman_tree_initialize(
     void )
{
	libcerror_error_t *error             = NULL;
	libgzipf_huffman_tree_t *huffman_tree = NULL;
	int result                           = 0;
	...
	huffman_tree = (libgzipf_huffman_tree_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libgzipf_huffman_tree_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libgzipf_huffman_tree_initialize with memset failing
		 */
...
/* Tests the libgzipf_huffman_tree_free function
 * Returns 1 if successful or 0 if not
 */
int gzipf_test_huffman_tree_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libgzipf_huffman_tree_build function
 * Returns 1 if successful or 0 if not
 */
int gzipf_test_huffman_tree_build(
     void )
{
	...
	/* Test regular cases
	 */
	result = libgzipf_huffman_tree_build(
	          huffman_tree,
	          code_size_array,
	          288,
	          &error );
	...
	/* Test libgzipf_huffman_tree_build with malloc failing
	 */
	...
	/* Test libgzipf_huffman_tree_build with memset failing
	 */
...
/* Tests the libgzipf_huffman_tree_get_symbol_from_bit_stream function
 * Returns 1 if successful or 0 if not
 */
int gzipf_test_huffman_tree_get_symbol_from_bit_stream(
     void )
{
	uint8_t code_size_array[ 318 ];
	...
	result = libgzipf_huffman_tree_get_symbol_from_bit_stream(
	          huffman_tree,
	          bit_stream,
	          &symbol,
	          &error );
	...
	GZIPF_TEST_ASSERT_EQUAL_UINT16(
	 "symbol",
	 symbol,
	 (uint16_t) 141 );
...
#endif
{
	...
	GZIPF_TEST_RUN(
	 "libgzipf_huffman_tree_initialize",
	 gzipf_test_huffman_tree_initialize );

	GZIPF_TEST_RUN(
	 "libgzipf_huffman_tree_free",
	 gzipf_test_huffman_tree_free );

	GZIPF_TEST_RUN(
	 "libgzipf_huffman_tree_build",
	 gzipf_test_huffman_tree_build );

	GZIPF_TEST_RUN(
	 "libgzipf_huffman_tree_get_symbol_from_bit_stream",
	 gzipf_test_huffman_tree_get_symbol_from_bit_stream );
