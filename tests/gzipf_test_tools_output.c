     ...
     void )
{
	...
	result = gzipftools_output_initialize(
	          _IONBF,
	          &error );
...
#endif
{
	...
	GZIPF_TEST_RUN(
	 "gzipftools_output_initialize",
	 gzipf_test_tools_output_initialize )

	/* TODO add tests for gzipftools_output_copyright_fprint */

	/* TODO add tests for gzipftools_output_version_fprint */

	/* TODO add tests for gzipftools_output_version_detailed_fprint */
