...
#include "../gzipftools/info_handle.h"

/* Tests the info_handle_initialize function
 * Returns 1 if successful or 0 if not
 */
int gzipf_test_tools_info_handle_initialize(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int gzipf_test_tools_info_handle_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	GZIPF_TEST_RUN(
	 ...
	 gzipf_test_tools_info_handle_initialize );

	GZIPF_TEST_RUN(
	 "info_handle_free",
	 gzipf_test_tools_info_handle_free );
