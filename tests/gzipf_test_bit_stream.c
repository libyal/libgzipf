...
#include "gzipf_test_libcnotify.h"
#include "gzipf_test_macros.h"
#include "gzipf_test_memory.h"
#include "gzipf_test_unused.h"

#include "../libgzipf/libgzipf_bit_stream.h"

/* Define to make gzipf_test_bit_stream generate verbose output
#define GZIPF_TEST_BIT_STREAM_VERBOSE
 */

uint8_t gzipf_test_bit_stream_data[ 16 ] = {
...
/* Tests the libgzipf_bit_stream_initialize function
 * Returns 1 if successful or 0 if not
 */
int gzipf_test_bit_stream_initialize(
     void )
{
	...
	/* Test regular cases
	 */
	result = libgzipf_bit_stream_initialize(
	          &bit_stream,
	          gzipf_test_bit_stream_data,
	          16,
	          0,
	...
	result = libgzipf_bit_stream_free(
	          &bit_stream,
	          &error );
	...
	bit_stream = (libgzipf_bit_stream_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libgzipf_bit_stream_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libgzipf_bit_stream_initialize with memset failing
		 */
...
/* Tests the libgzipf_bit_stream_free function
 * Returns 1 if successful or 0 if not
 */
int gzipf_test_bit_stream_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libgzipf_bit_stream_get_value function
 * Returns 1 if successful or 0 if not
 */
int gzipf_test_bit_stream_get_value(
     void )
{
	libcerror_error_t *error         = NULL;
	libgzipf_bit_stream_t *bit_stream = NULL;
	...
	/* Test regular cases
	 */
	result = libgzipf_bit_stream_get_value(
	          bit_stream,
	          0,
	          &value_32bit,
	          &error );
...
#endif
{
...
#if defined( HAVE_DEBUG_OUTPUT ) && defined( GZIPF_TEST_BIT_STREAM_VERBOSE )
	...
	GZIPF_TEST_RUN(
	 "libgzipf_bit_stream_initialize",
	 gzipf_test_bit_stream_initialize );

	GZIPF_TEST_RUN(
	 "libgzipf_bit_stream_free",
	 gzipf_test_bit_stream_free );

	GZIPF_TEST_RUN(
	 "libgzipf_bit_stream_get_value",
	 gzipf_test_bit_stream_get_value );
